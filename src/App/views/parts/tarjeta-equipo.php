        ...
        <li class="ranking-item">
            <article class="team-card">
                ...
                <section class="card stats-card">
                    ...
                    <ul>
                        <li><strong>Partidos jugados:</strong> <?= htmlspecialchars($jugados, ENT_QUOTES, 'UTF-8') ?>
                        </li>
                        ...
                        <li><strong>Diferencia de gol:</strong>
                            <?= $diferenciaGol >= 0 ? '+' : '' ?><?= $diferenciaGol ?>
                        </li>
                        <li><strong>ELO actual:</strong>
                            <?= htmlspecialchars($equipo->getEloActual(), ENT_QUOTES, 'UTF-8') ?></li>
                        <li><strong>ELO más alto:</strong> <?= htmlspecialchars($eloMasAlto, ENT_QUOTES, 'UTF-8') ?>
                        </li>
                        ...
                        <li><strong>Tarjetas rojas totales:</strong>
                            <?= htmlspecialchars($rojas, ENT_QUOTES, 'UTF-8') ?>
                        </li>
                        <li><strong>Asistencias:</strong> <?= htmlspecialchars($asistencias, ENT_QUOTES, 'UTF-8') ?>
                        </li>
                ...
                <section class="charts-card">
                    <article class="chart-card">
                        <h3 class="title-subsection">Gráfico de resultados</h3>
                        <canvas id="resultsChart" width="350" height="250" data-wins="<?= (int) $ganados ?>"
                            data-draws="<?= (int) $empatados ?>" data-losses="<?= (int) $perdidos ?>">
                        </canvas>
                    </article>

                    <article class="chart-card">
                        <h3 class="title-subsection">Goles</h3>
                        <canvas id="goalsChart" width="350" height="250" data-goles="<?= (int) $goles ?>"
                            data-golescontra="<?= (int) ($golesEnContra ?? 0) ?>">
                        </canvas>
                    </article>
                </section>
            </article>
