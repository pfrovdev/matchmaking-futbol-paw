...
class HistorialPartidoDto
{
    ...
    public function __construct(string $fecha_finalizacion, ResultadoPartidoDto $resultadoPerdedor, ResultadoPartidoDto $resultadoGanador, bool $soy_observador = false)
    {
